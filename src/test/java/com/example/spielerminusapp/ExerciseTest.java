...
public class ExerciseTest {
    ...
    public void testGetExerciseForAthlete() throws Exception {
        ...
        mockMvc.perform(get("/athletes/exercise/{athleteId}", athleteId)
                ...
                .andExpect(jsonPath("$[0].rule[0].id").value(54))
                .andExpect(jsonPath("$[0].rule[0].gender").value("M"))
                .andExpect(jsonPath("$[0].rule[0].fromAge").value(16))
                .andExpect(jsonPath("$[0].rule[0].toAge").value(17))
                .andExpect(jsonPath("$[0].rule[0].valueBronze").value(3400))
                .andExpect(jsonPath("$[0].rule[0].valueSilver").value(3800))
                .andExpect(jsonPath("$[0].rule[0].valueGold").value(4200))
                .andExpect(jsonPath("$[0].rule[0].metric").value("METERS"))
                .andExpect(jsonPath("$[0].rule[0].label").value("Wurfball (200 g)"))
                .andExpect(jsonPath("$[1].id").exists())
                .andExpect(jsonPath("$[1].title").value("KugelstoÃŸen"))
                .andExpect(jsonPath("$[1].exerciseType").value("KRAFT"))
                .andExpect(jsonPath("$[1].rule[0].id").value(66))
                .andExpect(jsonPath("$[1].rule[0].gender").value("M"))
                .andExpect(jsonPath("$[1].rule[0].fromAge").value(16))
                .andExpect(jsonPath("$[1].rule[0].toAge").value(17))
                .andExpect(jsonPath("$[1].rule[0].valueBronze").value(750))
                .andExpect(jsonPath("$[1].rule[0].valueSilver").value(800))
                .andExpect(jsonPath("$[1].rule[0].valueGold").value(850))
                .andExpect(jsonPath("$[1].rule[0].metric").value("METERS"))
                .andExpect(jsonPath("$[1].rule[0].label").value("5 kg"));
