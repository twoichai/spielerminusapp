...
VALUES ('M', 6, 7, 540, 500, 415, 'MINUTES', NULL, 1),                            -- 800m Lauf --
       ...
       ('M', 6, 7, -1, -1, -1, 'METERS', 'Nicht für das Alter 6-7 möglich',
        13),                                                                      -- Hochsprung  -- starts with 0, what to do?
       ...
       ('M', 6, 7, 10, 15, 25, 'CUSTOM', 'Grundsprung vorwärts mit oder ohne Zwischensprung ODER Galoppsprung',
        18),                                                                      -- Seilspringen
